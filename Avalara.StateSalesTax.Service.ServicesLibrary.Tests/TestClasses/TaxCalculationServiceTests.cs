...
{
    public class TaxCalculationServiceTests : DbContextDependentBase
    {
        private readonly ITaxCalculationService _TaxCalculationService;

        public TaxCalculationServiceTests(ITaxCalculationService taxCalculationService, StateSalesTaxDbContext dbContext) : base(dbContext)
        {
            _TaxCalculationService = taxCalculationService;
        }

        [Fact]
        public async Task TaxCalculationService_CalculateTaxes_ForWakeForestZipCode_WithQ42019TaxRates()
        {
            ...
            var result = await _TaxCalculationService.CalculateTaxesAsync(retailTransactionDto);
